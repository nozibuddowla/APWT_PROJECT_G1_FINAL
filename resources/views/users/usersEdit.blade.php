...
<html lang="en">
  ...
  <div class="container">
    ...
    <h5 class="mt-5 mb-5">Edit User</h5>
    ...
    @csrf
      ...
      <div class="form-group">
        ...
        <input type="" class="form-control" id="companyName" name="companyName" value="{{$companyName}}">
      </div>
      <div class="form-group">
        <label for="name">username</label>
        <input type="" class="form-control" id="username" name="username" value="{{$username}}">
      </div>
      <div class="form-group">
        <label for="contactno">contact no</label>
        <input class="form-control" id="contactno" name="contactno" value="{{$contactno}}">
      </div>
      <div class="form-group">
