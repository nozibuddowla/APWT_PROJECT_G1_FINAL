    ...
    <div class='container'>
        ...
        <form method='post' class='mt-5'>
            ...
            <div class="form-group">
                ...
                <input name='login' value="{{ old('login') }}" type="" class="form-control"
        ...
        <div><a href="/login/github" class="btn btn-secondary" style="margin-top: 10px;">Sign In With Github</a></div>
